...
class TencentcsHttpServiceFactory {
    ...
    TencentcsHttpServiceFactory(String accessId, String secretKey, String token, String hostName) {
        ...
        mTencentcsPublicInterceptor = new TencentcsPublicInterceptor(accessId, secretKey, token, hostName);
