...
public class StorageManager {
     ...
     * 本地回放文件缩率图保存目录
     * */
    private static String APP_PLAY_BACK_THUMB_PATH;
    ...
    public static void init(Application app) {
        ...
        File thumbDirectory = app.getExternalFilesDir("SdThumbCache");
        ...
        if (thumbDirectory != null && thumbDirectory.exists()) {
            APP_PLAY_BACK_THUMB_PATH = thumbDirectory.getPath();
        }
    }
    ...
    public static String getSdThumbPath() {
        return APP_PLAY_BACK_THUMB_PATH;
    }
