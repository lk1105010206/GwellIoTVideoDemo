...
public class MonitorPlayerFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mVideoView.setLongPressedListener(e -> {
        ...
        mMonitorPlayerOwner.setSeekBar(view.findViewById(R.id.sb_revise_view_size));
    }
    ...
    private void createMonitorPlayOwner(String deviceId) {
        ...
        config.saveDevVideoRawFile = true;
        config.saveDevVideoYUVFile = true;
        ...
        mMonitorPlayerOwner.addOnSpeedChangedListener(speed -> mTvPersonAndSpeed.setText(String.format("%s人观看  %sKB/S", monitorViewerNumber, (speed / 1000))));
        mMonitorPlayerOwner.setInnerUserDataListener(new AInnerUserDataLister() {
            @Override
            public void onTalkerNumberChanged(byte talkerNumber) {
                LogUtils.i(TAG,"onTalkerNumberChanged talkerNumber:" + talkerNumber);
            }
    ...
    public void onDestroy() {
        ...
        if (null != mVideoView) {
            if (null != mVideoView.mAudioRender) {
                mVideoView.mAudioRender.onRelease();
            }
            if (null != mVideoView.mGLRenderer) {
                mVideoView.mGLRenderer.onRelease();
            }
        }
    }
