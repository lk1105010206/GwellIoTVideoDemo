...
//                LogUtils.i(TAG, "schedule time");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_iot_monitor_state:
                ...
                break;
            case R.id.tv_iot_definition:
                if (mOwner == null) {
                    break;
                }
                showDefinitionPopupMenu(view);
                break;
        }
    }
    ...
    public void setMonitorOwner(MonitorPlayerOwner owner) {
        ...
        mOwner.addStatusListener(new IStatusListener() {
            ...
            public void onStatus(int status) {
                LogUtils.i(TAG, "onStatus:" + status);
    ...
    public void definitionClicked(Definition definition) {
        switch (definition) {
            case HD:
                mTvDefinition.setText("HD");
                break;
            case SD:
                mTvDefinition.setText("SD");
                break;
            case LD:
                mTvDefinition.setText("LD");
                break;
        }
        if (mOwner != null) {
    ...
    private void showDefinitionPopupMenu(final View anchor) {
        if (mContext == null) {
            return;
        }
        PopupMenu popupMenu = new PopupMenu(mContext, anchor);
        popupMenu.getMenuInflater().inflate(R.menu.change_definition__popup_menu, popupMenu.getMenu());
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_menu_change_hd:
                        definitionClicked(Definition.HD);
                        break;
                    case R.id.action_menu_change_sd:
                        definitionClicked(Definition.SD);
                        break;
                    case R.id.action_menu_change_ld:
                        definitionClicked(Definition.LD);
                        break;
                }
                return false;
            }
