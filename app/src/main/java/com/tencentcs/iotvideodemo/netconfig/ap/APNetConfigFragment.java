...
public class APNetConfigFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (mLanDeviceInfo != null) {
            mTvDeviceInfo.setText(String.format("deviceId : %s",
                    DeviceUtils.isValidTid(mLanDeviceInfo.tencentID) ? mLanDeviceInfo.tencentID : (mLanDeviceInfo.deviceID + "(did)")));
        }
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.send_net_config_info) {
            ...
            int sendResult = mNetConfigInfoViewModel.sendNetConfigInfoViaAP(DeviceUtils.isValidTid(mLanDeviceInfo.tencentID) ? mLanDeviceInfo.tencentID : (String.valueOf(mLanDeviceInfo.deviceID)));
    ...
    private void updateDeviceInfoText() {
        switch (mNetConfigState) {
            ...
            case SearchingDevice:
                ...
                break;
            case FindDevice:
                mTvDeviceInfo.setText(String.format("deviceId : %s", DeviceUtils.isValidTid(mLanDeviceInfo.tencentID) ? mLanDeviceInfo.tencentID : (mLanDeviceInfo.deviceID + "(did)")));
