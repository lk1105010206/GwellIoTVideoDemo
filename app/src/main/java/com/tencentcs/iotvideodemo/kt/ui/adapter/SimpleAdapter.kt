...
import com.tencentcs.iotvideodemo.kt.ui.adapter.ViewHolder.Companion.getViewHolder

open class SimpleAdapter<T> constructor(dataList: MutableList<T>, vararg item: ItemHolder<T>, var onItemViewType: ((item: T, position: Int) -> Int)? = null) : RecyclerView.Adapter<ViewHolder<T>>() {

    var data: MutableList<T> = dataList
        set(value) {
            field = value
