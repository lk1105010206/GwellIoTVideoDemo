...
public class LoadingDialog extends Dialog {
    ...
    private void initDialog(Context ctx) {
        ...
        mProgressView = view.findViewById(R.id.progress_login);
        mFlRootView = view.findViewById(R.id.fl_loading);
...
//        int height = (int) (100 * scale + 0.5f);
    ...
    private void showProgress(final boolean show) {
        ...
        mFlRootView.setVisibility(show ? View.VISIBLE : View.GONE);
